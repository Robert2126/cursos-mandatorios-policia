...
class Settings(BaseSettings):
    ...
    database_path: Path = Path(__file__).resolve().parent / "data" / "advisor.db"
    ...
    trusted_origins_csv: str = Field(default="http://localhost:8000,http://localhost:3000", validation_alias="TRUSTED_ORIGINS")
